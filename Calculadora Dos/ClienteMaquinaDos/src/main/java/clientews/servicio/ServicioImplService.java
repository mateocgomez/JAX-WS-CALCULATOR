 ...
 * 
 */
@WebServiceClient(name = "ServicioImplService", targetNamespace = "http://beans/", wsdlLocation = "http://desktop-9iivphm:8080/ServicioImplService/ServicioImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOIMPLSERVICE_QNAME = new QName("http://beans/", "ServicioImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://desktop-9iivphm:8080/ServicioImplService/ServicioImpl?wsdl");
     ...
     * 
     * @return
     *     returns ServicioMaquinaDosWS
     */
    @WebEndpoint(name = "ServicioImplPort")
    public ServicioMaquinaDosWS getServicioImplPort() {
        return super.getPort(new QName("http://beans/", "ServicioImplPort"), ServicioMaquinaDosWS.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicioImplPort")
    public ServicioMaquinaDosWS getServicioImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://beans/", "ServicioImplPort"), ServicioMaquinaDosWS.class, features);
    }
